...
const kTextUngu = Color(0xffAD1457);
const kTextPutih = Colors.white;
const ktransparan = Color(0x00000000);
const kungutipis = Color(0xFFf8bbd0);
const kungupekat = Color(0xFF880E4F);